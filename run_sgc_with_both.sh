...
echo "SGC ogb-arxiv"
echo "edges,h_den,h_den_train,h_den_val,h_den_test,h_edge,h_node,h_norm,degree,train_acc,test_acc,val_acc,train_acc_std,test_acc_std,val_acc_std"
#CPU_ONLY=True python -m benchmark.node_classification.sgc --with_rand_signal --with_node_feature --dataset=Penn94 --rewired --rewirer_step=0.1 --K=1 --edge_step=70000 --max_node_degree=100
#CPU_ONLY=True python -m benchmark.node_classification.sgc --with_rand_signal --with_node_feature --dataset=Penn94 --rewired --rewirer_step=0.1 --K=2 --edge_step=70000 --max_node_degree=100
#CPU_ONLY=True python -m benchmark.node_classification.sgc --with_rand_signal --with_node_feature --dataset=Penn94 --rewired --rewirer_step=0.1 --K=3 --edge_step=70000 --max_node_degree=100
#CPU_ONLY=True python -m benchmark.node_classification.sgc --with_rand_signal --with_node_feature --dataset=ogbn-arxiv --rewired --rewirer_step=0.2 --K=1 --edge_step=70000 --max_node_degree=100
#CPU_ONLY=True python -m benchmark.node_classification.sgc --with_rand_signal --with_node_feature --dataset=ogbn-arxiv --rewired --rewirer_step=0.2 --K=2 --edge_step=70000 --max_node_degree=100
CPU_ONLY=True python -m benchmark.node_classification.sgc --with_rand_signal --with_node_feature --dataset=ogbn-arxiv --rewired --rewirer_step=0.2 --K=3 --edge_step=70000 --max_node_degree=100
