...
echo "GAT Actor"
echo "edges,h_den,h_den_train,h_den_val,h_den_test,h_edge,h_node,h_norm,degree,density,train_acc,test_acc,val_acc,train_acc_std,test_acc_std,val_acc_std"
CUDA_DEVICE=0 python -m benchmark.node_classification.gat  --with_rand_signal --with_node_feature --dataset=Actor --rewired --rewirer_step=0.1 --model_indices 0 --dropout=0.3 --edge_step=2500 --hidden=256 --run_split=0 --heads=8
CUDA_DEVICE=0 python -m benchmark.node_classification.gat  --with_rand_signal --with_node_feature --dataset=Actor --rewired --rewirer_step=0.1 --model_indices 0 --dropout=0.2 --edge_step=2500 --hidden=256 --run_split=1 --heads=8
CUDA_DEVICE=0 python -m benchmark.node_classification.gat  --with_rand_signal --with_node_feature --dataset=Actor --rewired --rewirer_step=0.1 --model_indices 0 --dropout=0.3 --edge_step=2500 --hidden=1024 --run_split=2 --heads=8
CUDA_DEVICE=0 python -m benchmark.node_classification.gat  --with_rand_signal --with_node_feature --dataset=Actor --rewired --rewirer_step=0.1 --model_indices 0 --dropout=0.3 --edge_step=2500 --hidden=1024 --run_split=3 --heads=8
CUDA_DEVICE=0 python -m benchmark.node_classification.gat  --with_rand_signal --with_node_feature --dataset=Actor --rewired --rewirer_step=0.1 --model_indices 0 --dropout=0.3 --edge_step=2500 --hidden=64 --run_split=4 --heads=8
CUDA_DEVICE=0 python -m benchmark.node_classification.gat  --with_rand_signal --with_node_feature --dataset=Actor --rewired --rewirer_step=0.1 --model_indices 0 --dropout=0.3 --edge_step=2500 --hidden=128 --run_split=5 --heads=8
CUDA_DEVICE=0 python -m benchmark.node_classification.gat  --with_rand_signal --with_node_feature --dataset=Actor --rewired --rewirer_step=0.1 --model_indices 0 --dropout=0.3 --edge_step=2500 --hidden=512 --run_split=6 --heads=8
CUDA_DEVICE=0 python -m benchmark.node_classification.gat  --with_rand_signal --with_node_feature --dataset=Actor --rewired --rewirer_step=0.1 --model_indices 0 --dropout=0.3 --edge_step=2500 --hidden=1024 --run_split=7 --heads=8
CUDA_DEVICE=0 python -m benchmark.node_classification.gat  --with_rand_signal --with_node_feature --dataset=Actor --rewired --rewirer_step=0.1 --model_indices 0 --dropout=0.3 --edge_step=2500 --hidden=256 --run_split=8 --heads=8
CUDA_DEVICE=0 python -m benchmark.node_classification.gat  --with_rand_signal --with_node_feature --dataset=Actor --rewired --rewirer_step=0.1 --model_indices 0 --dropout=0.3 --edge_step=2500 --hidden=512 --run_split=9 --heads=8
