import torch
from kernel.utils import scatter_add_deterministic, index_to_ptr
...
class GlobalAttention(torch.nn.Module):
    ...
    def forward(self, x, batch, size=None):
        ...
        gate = softmax(gate, ptr=index_to_ptr(batch), num_nodes=size)
        out = scatter_add_deterministic(gate * x, batch)
